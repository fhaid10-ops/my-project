...
function looksLikeMenuResidue(text) {
  ...
  return /^(menu_[1-8]|تمويل شخصي|ابي تمويل شخصي|أبي تمويل شخصي|ابي تمويل|أبي تمويل|تمويل|ابدأ|ابدا|ابدأ الحسبة|ابدا الحسبة|شراء مديونية|شراء المديونية|مديونية الشركات|مديونية)$/i.test(
    t
  );
}
