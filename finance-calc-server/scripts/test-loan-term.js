...
assert.ok(String(electronic.reply).includes("عبدالرحمن"));
...
assert.ok(String(electronic.followUpReply).includes("ماجد"));
assert.ok(String(electronic.followUpReply).includes("قدم الان هنا"));
assert.ok(String(electronic.followUpReply).includes("https://portal.sfco.com.sa/?DSA=SF1888"));
assert.match(String(electronic.afterFollowUpReply), /^ملاحظه/);
assert.ok(String(electronic.afterFollowUpReply).includes("سجل مبلغ التمويل المرغوب فيه بالملاحظات"));
assert.ok(String(electronic.afterFollowUpReply).includes("SF1695"));
assert.ok(String(electronic.afterFollowUpReply).includes("SF1888"));
assert.ok(!String(electronic.afterFollowUpReply).includes("portal.sfco.com.sa"));
assert.ok(!String(electronic.afterFollowUpReply).includes("وارسلي رقم الطلب"));
